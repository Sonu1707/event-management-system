...
class TalkProposalController extends Controller
{
    ...
    // Method to display all talk proposals
    public function index()
    {
        $talkProposals = TalkProposal::with('speaker')->get(); // Fetch all proposals with speaker info
        return view('talk_proposals.index', compact('talkProposals')); // Return the view with proposals
    }
